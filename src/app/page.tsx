  ...
  return (
    <div className="bg-cream-50">
      ...
      <section className="relative min-h-[90vh] sm:min-h-screen flex items-end overflow-hidden">
        ...
        {/* Foto de fundo full-screen */}
        <Image
          src="https://images.unsplash.com/photo-1611085583191-a3b181a88401?w=1600&h=1100&q=90&auto=format&fit=crop&crop=center"
        ...
        {/* Overlay degradê — transparente no topo, escuro na base */}
        <div className="absolute inset-0 bg-gradient-to-t from-black/75 via-black/20 to-transparent" />

        {/* Texto sobre a foto */}
        <div className="relative z-10 w-full px-5 sm:px-12 lg:px-20 pt-32 pb-12 sm:pb-20">
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.7 }}
            className="text-cream-200 text-[10px] tracking-[0.4em] uppercase mb-6 font-medium"
          >
            Nova Coleção · 2025
          </motion.p>
          ...
          <motion.h1
            ...
            className="font-heading font-bold text-cream-50 leading-[0.95] mb-10 sm:mb-14 max-w-4xl"
            style={{ fontSize: 'clamp(3.2rem, 9vw, 8rem)' }}
          >
            Bijuterias<br />
            para quem<br />
            <em className="not-italic text-terracotta-400">sabe seu</em><br />
            valor.
          </motion.h1>
          ...
          >
            <Link
              href="/produtos"
              className="inline-flex items-center gap-3 text-cream-50 text-sm sm:text-base font-medium border-b border-cream-50/60 pb-0.5 hover:text-terracotta-400 hover:border-terracotta-400 transition-colors group"
            >
              Ver Coleção
            ...
            <Link
              ...
              className="inline-flex items-center gap-3 text-cream-300 text-sm sm:text-base hover:text-cream-50 transition-colors group"
            >
              Explorar Conjuntos
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </Link>
