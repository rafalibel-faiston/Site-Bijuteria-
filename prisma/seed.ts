...
async function main() {
  ...
  const produtos = [
    {
      ...
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=800&q=90&auto=format&fit=crop&crop=center',
        'https://images.unsplash.com/photo-1589128777073-263566ae5e4d?w=800&q=90&auto=format&fit=crop&crop=center',
      ]),
      categoria: 'Anéis',
    ...
    },
    {
      ...
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=800&q=90&auto=format&fit=crop&crop=center',
        'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=800&q=90&auto=format&fit=crop&crop=center',
      ]),
      categoria: 'Colares',
    ...
    },
    {
      ...
      precoOriginal: null,
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1630019852942-f89202989a59?w=800&q=90&auto=format&fit=crop&crop=center',
        'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=800&q=90&auto=format&fit=crop&crop=center',
      ]),
      categoria: 'Brincos',
    ...
    },
    {
      ...
      precoOriginal: 85.00,
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1573408301185-9519f94816b5?w=800&q=90&auto=format&fit=crop&crop=center',
        'https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=800&q=90&auto=format&fit=crop&crop=center',
      ]),
      categoria: 'Pulseiras',
      material: 'Metal banhado a ouro',
      peso: 6,
    ...
    },
    {
      ...
      precoOriginal: 99.90,
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=800&q=90&auto=format&fit=crop&crop=center',
        'https://images.unsplash.com/photo-1612817288484-6f916006741a?w=800&q=90&auto=format&fit=crop&crop=center',
      ]),
      categoria: 'Colares',
    ...
    },
    {
      ...
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1511464510422-77dcbea5d6e9?w=800&q=90&auto=format&fit=crop&crop=center',
        'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=800&q=90&auto=format&fit=crop&crop=center',
      ]),
      categoria: 'Anéis',
    ...
    },
    {
      ...
      precoOriginal: null,
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?w=800&q=90&auto=format&fit=crop&crop=center',
        'https://images.unsplash.com/photo-1630019852942-f89202989a59?w=800&q=90&auto=format&fit=crop&crop=center',
      ]),
      categoria: 'Brincos',
    ...
    },
    {
      ...
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1611085583191-a3b181a88401?w=800&q=90&auto=format&fit=crop&crop=center',
        'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=800&q=90&auto=format&fit=crop&crop=center',
      ]),
      categoria: 'Conjuntos',
    ...
    },
    {
      ...
      precoOriginal: null,
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1601121141461-9d6647bef0a7?w=800&q=90&auto=format&fit=crop&crop=center',
        'https://images.unsplash.com/photo-1511464510422-77dcbea5d6e9?w=800&q=90&auto=format&fit=crop&crop=center',
      ]),
      categoria: 'Anéis',
      material: 'Metal dourado',
    ...
    {
      nome: 'Brinco Ear Cuff Minimalista',
      slug: 'brinco-ear-cuff-minimalista',
      descricao: 'Ear cuff delicado que se ajusta sem furo. Banhado a ouro, perfeito para compor looks modernos.',
      preco: 42.90,
      precoOriginal: 55.00,
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1611085583191-a3b181a88401?w=800&q=90&auto=format&fit=crop&crop=center',
    ...
    {
      nome: 'Colar Gargantilha Delicada',
      slug: 'colar-gargantilha-delicada',
      descricao: 'Gargantilha fina e ajustável, ideal para sobreposição. Acabamento dourado de longa duração.',
      preco: 69.90,
      precoOriginal: 89.00,
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1589128777073-263566ae5e4d?w=800&q=90&auto=format&fit=crop&crop=center',
    ...
    {
      nome: 'Anel Duplo Cravejado',
      slug: 'anel-duplo-cravejado',
      descricao: 'Anel de dois aros com micro zircônias. Brilho discreto para o dia a dia ou para a noite.',
      preco: 98.00,
      ...
      categoria: 'Anéis',
      material: 'Metal banhado a ouro e zircônia',
      peso: 5,
      estoque: 14,
      estoqueMinimo: 5,
      vendas: 52,
    ...
    {
      nome: 'Pulseira Riviera de Cristais',
      slug: 'pulseira-riviera-cristais',
      descricao: 'Pulseira riviera com cristais em sequência. Elegante e versátil, fecho seguro tipo lagosta.',
      preco: 115.00,
    ...
    },
    {
      ...
      descricao: 'Conjunto de colar e brincos com pérolas sintéticas. Atemporal, perfeito para presentear.',
      preco: 159.90,
  ...
  for (const produto of produtos) {
    await prisma.produto.upsert({
      ...
      update: { imagens: produto.imagens },
      create: produto,
    })
  }
