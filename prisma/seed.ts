  ...
  const produtos = [
    {
      ...
      imagens: JSON.stringify([
        ...
        'https://images.unsplash.com/photo-1611085583191-a3b181a88401?w=800&q=85&auto=format&fit=crop',
      ]),
      categoria: 'Anéis',
    ...
    },
    {
      ...
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=800&q=85&auto=format&fit=crop',
    ...
    },
    {
      ...
      precoOriginal: null,
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1630019852942-f89202989a59?w=800&q=85&auto=format&fit=crop',
    ...
    },
    {
      ...
      precoOriginal: 85.00,
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1573408301185-9519f94816b5?w=800&q=85&auto=format&fit=crop',
        'https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=800&q=85&auto=format&fit=crop',
      ]),
      categoria: 'Pulseiras',
      material: 'Metal banhado a ouro',
      peso: 6,
    ...
    },
    {
      ...
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1511464510422-77dcbea5d6e9?w=800&q=85&auto=format&fit=crop',
        'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=800&q=85&auto=format&fit=crop',
      ]),
      categoria: 'Anéis',
    ...
    },
    {
      ...
      precoOriginal: null,
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=800&q=85&auto=format&fit=crop',
        'https://images.unsplash.com/photo-1630019852942-f89202989a59?w=800&q=85&auto=format&fit=crop',
      ]),
      categoria: 'Brincos',
    ...
    },
    {
      ...
      precoOriginal: null,
      imagens: JSON.stringify([
        'https://images.unsplash.com/photo-1601121141461-9d6647bef0a7?w=800&q=85&auto=format&fit=crop',
        'https://images.unsplash.com/photo-1511464510422-77dcbea5d6e9?w=800&q=85&auto=format&fit=crop',
      ]),
      categoria: 'Anéis',
      material: 'Metal dourado',
